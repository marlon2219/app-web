<?php
    ...
    if(isset($_POST['opcion'])){
        $ordenar = $_POST['opcion'];
        if($ordenar === "ascendente"){
            $ordenar = "ASC";
        }elseif ($ordenar === "descendente"){
            $ordenar = " DESC";
        }
    }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="vistaUsuario.php">HEADSHOT</a>
                ...
                <nav style="width:100%; height:5rem; border-top: 1px solid #FFFFFF;" class="navbar navbar-light bg-dark">
            <div class="container-fluid">
                <form style=" margin: auto;width: 50rem;" class="d-flex" action="buscar.php" method="post">
                <input class="form-control me-2" name="busqueda" type="search" placeholder="Search" aria-label="Search">
                <select name="opcion">
                ...
                <button style="margin-left:6px" class="btn btn-outline-success" type="submit">Search</button>
                </form>
    ...
    $resultado= mysqli_query($conexion2,"SELECT * FROM fotos WHERE nombre LIKE '%$busqueda%' ORDER BY nombre $ordenar ");
